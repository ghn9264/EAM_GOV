...
namespace EAM.Data.ImportAndExport.Export.ExportDoAssets
{
    ...
    /// 导出报修单
    /// </summary>
    public class ExportDoAssetsRepair : ExportDoAssetsBase
    {
        public ExportDoAssetsRepair(IAssetsOptionService assetsOptionService, int doAssetsId)
        ...
        {
            get { return string.Format("AssetsRepair_{0}.xls", DoAssetsId); }
        }
        ...
        protected override void BuildHeader()
        {
            ...
            TempCell.CellStyle = CommCellStyle;
            TempCell.SetCellValue(string.Format("保修人：{0}", _repairDto.RepairInfo.RepairPerson));
            ...
            TempCell = TempRow.CreateCell(0);
            TempCell.CellStyle = CommCellStyle;
            TempCell.SetCellValue(string.Format("所在部门：{0}", _repairDto.RepairInfo.RepairDepartment));
            Sheet.AddMergedRegion(new CellRangeAddress(NextRowIndex, NextRowIndex, 0, 1));
            TempCell = TempRow.CreateCell(2);
            TempCell.CellStyle = CommCellStyle;
            TempCell.SetCellValue(string.Format("联系方式：{0}", _repairDto.RepairInfo.RepairPersonPhone));
            Sheet.AddMergedRegion(new CellRangeAddress(NextRowIndex, NextRowIndex, 2, 3));
        ...
        protected override void FillBody()
        {
            ...
            TempRow.CreateCell(5).SetCellValue("问题描述");
            ...
            foreach (var detail in _repairDto.Details)
            {
                ...
                TempRow.CreateCell(5).SetCellValue(detail.ErrorDescript);
                NextRowIndex++;
            }
        }

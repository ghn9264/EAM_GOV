...
namespace EAM.Data.ImportAndExport.Import
{
    public class PyImport
    {
        ...
        public PyImport(IAssetsService assetsService, IImportHistoryService importHistoryService, IUnImportAssetsService unImportAssetsService)
        {
        ...
        public ImportResult DoImport(string filePath, ref ProgressInfo importProgress, IImportHistoryService importHistoryService, IUnImportAssetsService unImportAssetsService)
        {
            ...
            // 从导入文件中提取数据
            //
            var list = DtReader.ReadPData(filePath, ref importProgress, _importHistoryService, _unImportAssetsService);
            ...
            foreach (AssetsMainExt assetsExt in list)
            {
                try
                {
                    ...
                    _assetsService.AddAssets(assetsExt);
                }
                //
                // 如果数据导入异常则记录导入异常问题
                //

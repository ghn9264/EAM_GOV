...
{
    public class ExportBuild : ExportAssetsBase
    {
        public ExportBuild(IAssetsService assetsService)
            : base(assetsService)
        {
        ...
        {
            get { return AssetsTypes.Building; }
        }

        public override string SaveFileName
        {
            get { return @"ZC03_构筑物_导入模板.xls"; }
        }
        ...
        protected override void BuildHeader()
        {
            ...
            TempRow.CreateCell(10).SetCellValue("权属证号");
            TempRow.CreateCell(11).SetCellValue("构筑物面积（平米）");
            TempRow.CreateCell(12).SetCellValue("坐落位置");
        ...
        protected override void FillBody()
        {
            ...
            for(int index=0;index<AssetsData.Count;index++)
            {
                ...
                var attrData = AssetsService.GetBuilding(main.AssetsNum);
                if (null != attrData)
                {
                    TempRow.CreateCell(9).SetCellValue(attrData.PropertyForm);
                    TempRow.CreateCell(10).SetCellValue(attrData.OwnershipCertifiateNum);
                    TempRow.CreateCell(11).SetCellValue(attrData.Area.ToString());
                    TempRow.CreateCell(12).SetCellValue(attrData.Location);
                ...
                TempRow.CreateCell(17).SetCellValue(main.Depreciation.ToString());
                TempRow.CreateCell(18).SetCellValue(main.AccumulateDepreciation.ToString());
                TempRow.CreateCell(19).SetCellValue(main.NetWorth.ToString());
                TempRow.CreateCell(20).SetCellValue(main.PostingDate.ToShortDateString());
                TempRow.CreateCell(21).SetCellValue(main.AcountDocNum);
                TempRow.CreateCell(22).SetCellValue(main.Memo);
                NextRowIndex++;
                Thread.Sleep(10);
            }
        }

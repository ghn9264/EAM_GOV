...
namespace EAM.Data.ImportAndExport
{
    public static class Mappings
    {
        ...
        /// 用户字段映射字典
        /// </summary>
        public static Dictionary<string, string> UserMapping;

        /// <summary>
        /// 位置字段映射字典
        /// </summary>
        public static Dictionary<string, string> PlaceMapping;
        ...
        static Mappings()
        {
            ...
            DtAssetsMapping = new Dictionary<string, string>
            {
                ...
                {"StorePlace","存放地点"},
                {"UsePeople","使用人"},
                {"UseDepartment","使用管理部门"},
                {"Memo","备注"},
                {"InventoryProfit","资产类型"},
            ...
            #region PlaceMapping
            PlaceMapping = new Dictionary<string, string>
            {
                {"ParentName","父级名称"},
                {"PlaceName","名称"}
            };

...
{
    public class ExportGeneral : ExportAssetsBase
    {
        public ExportGeneral(IAssetsService assetsService)
            : base(assetsService)
        {
        ...
        {
            get { return AssetsTypes.GeneralEquipment; }
        }

        public override string SaveFileName
        {
            get { return @"ZC05_通用设备_模板.xls"; }
        }
        ...
        protected override void BuildHeader()
        {
            ...
            TempRow.CreateCell(10).SetCellValue("设备用途");
           // TempRow.CreateCell(11).SetCellValue("生产厂家");

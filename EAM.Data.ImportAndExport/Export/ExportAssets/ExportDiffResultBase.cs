...
{
    public abstract class ExportDiffResultBase : ExportDynamicBase
    {
        protected IAssetsService AssetsService;
        protected List<DiffResult> AssetsData;
        ...
        public ExportDiffResultBase(IAssetsService assetsService)
            : base()
        {
        ...
        protected override void QueryData()
        {
            ...
            AssetsData = AssetsService.QueryAllDiffResult();
        }
